		...
		<div class="row">
		  ...
		  <div class="col-sm-6 col-md-4">
		    <div class="thumbnail">
		      ...
		      <div class="caption">
		        <a href="ProductList.do?p_code=${prod.p_code }">${prod.p_name }</a>
		        <h3>
		          <fmt:formatNumber value="${prod.p_price }" type="currency" />
		        </h3>
		      </div>
		    </div>
		  	  </div>
		...
		<table class="table">
			...
			<c:forEach var="list" items="${notiList }" varStatus="status">
				<tr>
					<td>${status.count }</td>
					<td>
					  <a href="${path }/NoticeListDetail.do?notice_no=${list.notice_no }">
					    ${list.notice_title }
					  </a>
					</td>
					<td>${list.user_id }</td>
