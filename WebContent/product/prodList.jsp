  ...
  <table class="table">
	<tbody>
	  ...
	  <c:if test="${uid.equals('admin') }">
	    <tr>
	      <td>
	        <a href="UpdateProduct.do?p_code=${prod.p_code }" class="btn btn-default" role="button">
	                        헤당 물품 편집(재고 관리 포함)
	        </a>
	        <a href="${path }/OrderListByPcode.do?p_code=${prod.p_code }" class="btn btn-default" role="button">
	                        헤당 물품에 대한 주문 관리
			</a>
	        <a href="DeleteProduct.do?p_code=${prod.p_code }" class="btn btn-default" role="button">
	                        헤당 물품 삭제
			</a>
	        <a href="ReviewProduct.do?p_code=${prod.p_code }" class="btn btn-default" role="button">
			    헤당 물품에 대한 리뷰 관리
			</a>
	      </td>
	    </tr>
	  ...
	  <tr>
 	  ...
 	  <tr>
	    <td>
	      <a href="${path }/ProductCatList.do?catno=${prod.catno }" class="btn btn-default" role="button">
	      	제품목록 > ${catMap.get('catname') }으로 가기
	      </a>
	    </td>
	  </tr>
	</tbody>
