...
public class UpdateProductProCtrl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (pic1 == null){
			prod.setPic1(multi.getFilesystemName("og_pic1"));
		} else {
			prod.setPic1("."+savePath.substring(8, savePath.length())+"/"+multi.getFilesystemName("pic1"));
		}
		if (pic2 == null){
			prod.setPic2(multi.getFilesystemName("og_pic2"));
		} else {
			prod.setPic2("."+savePath.substring(8, savePath.length())+"/"+multi.getFilesystemName("pic2"));
		}
		if (pic3 == null){
			prod.setPic3(multi.getFilesystemName("og_pic3"));
		} else {
			prod.setPic3("."+savePath.substring(8, savePath.length())+"/"+multi.getFilesystemName("pic3"));
		}
